...
botoes.forEach((botao, indice) => {
    botao.addEventListener('click', () => {
        ...
        //OB1 passo 3 - verificar se já existe um botão selecionado, se sim, devemos remover 
        //a seleção dele
        desselecionarBotao()
        //OB2 passo 3 - verificar se já exista um personagem selecionado, se sim, devemos remover 
        //a seleção dele 
